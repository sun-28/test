...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r8x6vfo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r8x6vfo.containers.anotherwebservice.com/
...
```
git clone git@github.com:sun-28/test.git
cd container-r8x6vfo
```
...
```
docker attach container-r8x6vfo
```
